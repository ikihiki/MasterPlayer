========================================================================
    メイクファイル プロジェクト: MasterPlayer プロジェクトの概要
========================================================================

この MasterPlayer プロジェクトは、AppWizard により作成されました。

このファイルには、MasterPlayer プロジェクトを構成する各ファイルの内容の概略が記述されています。


MasterPlayer.vcxproj
